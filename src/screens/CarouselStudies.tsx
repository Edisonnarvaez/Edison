    ...
    <Slider {...settings}>
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <section className="flex justify-center items-center">
          <img src="./public/itsim.png" alt="itsim 1" className="object-cover max-w-full max-h-full" />
        </section>
      </section>
      ...
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <section className="flex justify-center items-center">
          <img src="./public/cetem.png" alt="itsim 1" className="object-cover max-w-full max-h-full" />
        </section>
      </section>
      ...
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <section className="flex justify-center items-center">
          <img src="./public/ucc.png" alt="itsim 1" className="object-cover max-w-full max-h-full" />
        </section>
      </section>
    </Slider>
  );
