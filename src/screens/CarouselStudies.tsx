  ...
  return (
    <Slider {...settings}>
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <p className="flex justify-center text-app-white">{t('studies1')}</p>
      ...
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <p className="flex justify-center text-app-white">{t('studies2')}</p>
      ...
      <section className="flex-1 h-[375px] p-12 bg-gray-800 flex flex-col items-center justify-center mx-auto">
        ...
        <p className="flex justify-center text-app-white">{t('studies3')}</p>
